...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('WorkoutUpdate', function() {
      beforeEach(function() {
        instance = new FitnessTrackerApi.WorkoutUpdate();
      });

      it('should create an instance of WorkoutUpdate', function() {
        // TODO: update the code to test WorkoutUpdate
        expect(instance).to.be.a(FitnessTrackerApi.WorkoutUpdate);
      });
